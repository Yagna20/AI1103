...
\begin{lstlisting}
https://github.com/Yagna20/AI1103/blob/main/Assignment%201.tex
\end{lstlisting}
%
...
\begin{itemize}
    \item 0 $\rightarrow$ elder male and younger male.
    \item 1 $\rightarrow$ elder male and younger female.
    \item 2 $\rightarrow$ elder female and younger male.
    \item 3 $\rightarrow$ elder female and younger female.
\end{itemize}
